    ...
    >
      ...
      <div className="mt-4 relative">
        ...
        <textarea
          ...
          className="w-full bg-zinc-800 border border-zinc-700 rounded-xl pl-11 pr-4 py-3 text-sm focus:outline-none focus:border-orange-500"
        />
      </div>
...
function Field({ icon: Icon, ...props }) {
  return (
    <div className="relative">
      ...
      <input
        {...props}
        className="w-full h-12 bg-zinc-800 border border-zinc-700 rounded-xl pl-11 pr-4 text-sm focus:outline-none focus:border-orange-500"
      />
    </div>
  );
}
