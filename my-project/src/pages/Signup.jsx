      ...
      <div className="w-full max-w-xl rounded-3xl border border-gray-800 bg-white/5 backdrop-blur-lg p-8 sm:p-10 shadow-2xl">
        ...
        <div className="mb-6  flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-full border border-orange-400 text-xs font-bold text-orange-400">
              PB
            </div>
          ...
          <button className="inline-flex items-center gap-1.5 text-sm text-orange-400 hover:text-orange-300 transition">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                key={s.name}
                type="button"
                className="flex items-center justify-center gap-2 rounded-xl border border-gray-700 bg-white/5 py-2.5 text-sm font-medium text-white transition-all hover:border-orange-400 hover:bg-orange-500/10"
              >
                {s.svg}
