      ...
      <nav className="bg-[#0B0B0F]/90 backdrop-blur-xl border-b border-white/5 py-4 px-6 relative z-[100]">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {isCategoriesOpen && (
                        ...
                        >
                          <Link to="/Workshop" className="text-gray-400 hover:text-white text-xs px-4 py-2 hover:bg-white/5 rounded-xl transition-all flex items-center gap-2">
                            <Cpu size={14} /> Workshops
                          </Link>
                          <Link to="/Webinar" className="text-gray-400 hover:text-white text-xs px-4 py-2 hover:bg-white/5 rounded-xl transition-all flex items-center gap-2">
          ...
          <div className="hidden lg:flex items-center gap-5">
            ...
            <Link to="/Dashboard" className="text-sm font-bold text-gray-400 hover:text-white transition-colors">Log In</Link>
                      ...
                      <AnimatePresence>
                        {isMobileConferenceOpen && (
                          <motion.div 
                            ...
                            className="pl-4 space-y-2 border-l border-white/10 mt-3 font-medium text-xs text-gray-400 overflow-hidden flex flex-col gap-1"
                          >
                            <Link to="/NatinalConference" onClick={() =>setIsOpen(false)} className="block py-1 hover:text-purple-500">National</Link>
                            <Link to="/InternationalConference" className="block py-1 hover:text-emerald-500">International</Link>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </div>
