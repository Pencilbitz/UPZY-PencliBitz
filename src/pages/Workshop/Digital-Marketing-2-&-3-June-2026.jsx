...
import DigitalMarketing from "../../assets/Workshop/Digital-Marketing-2-&-3-June-2026.jpeg"
...
function RegisterForm() {
  return (
    <div id="register">
      <GlowCard className="p-6 lg:p-8 text-center space-y-5">
        <h3 className="text-2xl font-bold">
          Register for Workshop
        </h3>
        
        <p className="text-sm text-zinc-400 leading-relaxed">
          Click below to fill out the official registration form via Google Forms and secure your spot in the workshop.
        </p>

        <a
          href="https://forms.gle/pCvJEcxnot2zeZnj7"
          target="_blank"
